...
static String doubt_response = "<!DOCTYPE html>\r\n" + 
   		...
   		"				<span class=\"heading-primary-main\">View Doubts</span>\r\n" + 
   		"				<span class=\"heading-primary-sub\">This is where you view all doubts.</span>\r\n" + 
   		"			</h1>\r\n" +  
   		"		</div>\r\n" + 
   		"	</div><br><br>"+
   		"   <div class=\"form\">";
                     ...
                     throws ServletException, IOException 
   {
      ...
      try 
      {
         ...
         conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/World", "root", "PASSWORD");  // <<== Check
